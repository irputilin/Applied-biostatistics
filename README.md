...
[_1 занятие_](lesson1.txt) - Установка R, RTools, RStudio. Знакомство с интерфейсом RStudio
...
_10 занятие_ - Регрессионный анализ. Линейная регрессия.

_11 занятие_ - Многомерные данные. 3D-визуализация

_12 занятие_ - Многомерные данные. Сокращение размерности данных методом главных компонент (PCA)
